---
title: 'Week 1 - Introductions, Reproducible Research, (a little) R, and (a little) Git'
subtitle: "August 18, 2021"
...
Well, in a normal year, this would go something like this:
* During lecture:
...
This year, I hope you can at least find a quiet place for an hour or two each week to devote to this.
...
![Git file lifecycle](./figure/git_file_lifecycle.png)
...
<http://r4ds.had.co.nz>  
![R data science](./figure/data-science-pipeline.png)  

## Reproducible Research Pipeline 

Further illustrated by Peng and Eckel (2008)  
```{r,out.width = "600px", echo=F}
    knitr::include_graphics("./figure/Peng_Eckel_2008.png",auto_pdf=F)
```
...
## Quick tour of Rstudio and R from Rstudio.cloud
1. panels
